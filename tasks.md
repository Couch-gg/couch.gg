...
| 2C | Generic manifest-driven controller | 2 | Sonnet | apps/web/src/components/GenericController.tsx (new), apps/web/src/routes/ControllerRoute.tsx, apps/web/src/styles.css | IN-FLIGHT | 0 | pinned: start label `${title} starten` (e2e back-compat) |
