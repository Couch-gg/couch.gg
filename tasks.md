...
| 4B | COUCH-GAME-GUIDE.md + starter template | 4 | Opus | packages/game-sdk/COUCH-GAME-GUIDE.md (new), templates/couch-game-starter/** (new), apps/web/scripts/copy-sdk.mjs (guide copy), README.md pointer | IN-FLIGHT (relaunch) | 0* | 1st attempt died on session limit before writing anything; fresh relaunch. ACCURACY GATE: every claim mapped to source file |
