...
export const WORLD_W = 960;            // logical pixels (internal resolution)
export const WORLD_H = 540;

export const TERRAIN_MIN_Y = 120;      // highest allowed terrain surface (y grows downward)
export const TERRAIN_MAX_Y = 500;      // lowest allowed terrain surface
export const TERRAIN_FLOOR_Y = 524;    // craters can never dig below this

export const GRAVITY = 200;            // px/s^2 downward
export const WIND_MAX = 50;            // max |wind| horizontal acceleration px/s^2
...
export const SPEED_MAX = 560;          // launch speed px/s at power 100 (speed = power/100*SPEED_MAX)
...
export const PLUNGE_VY_REF = 540;      // reference falling speed for the plunge multiplier
export const CHARGE_TIME_MS = 1800;    // hold-to-charge: POWER_MIN -> POWER_MAX over this span

// V2 SIEGE — castles (destructible forts).
export const CASTLE_TOWER_H = 32;      // tower height in stone columns (px)
export const CASTLE_DMG_PER_BLOCK = 0.1875; // hp bled to owner per destroyed block (¼ of the 1x value: ~4x as many 1px blocks)
...
export const CRATER_R = 32;            // terrain crater radius
export const DMG_MAX = 40;             // damage at epicenter
export const DMG_RADIUS = 52;          // damage falls linearly to 0 at this distance
export const PLAYER_HP = 100;
export const PLAYER_HIT_R = 18;        // player collision circle radius
export const PLAYER_HIT_DY = -12;      // hit circle center offset from base (x, y+PLAYER_HIT_DY)
export const MUZZLE_DY = 28;           // projectile spawns at (x, y - MUZZLE_DY)
